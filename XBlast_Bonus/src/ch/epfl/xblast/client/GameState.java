...
{   
    ...
    public GameState(List<Player> players, List<Image> boardImages,List<Image> explosionsImages,List<Image> scoreImages,List<Image> timeImages, Image winnerImage) 
    {
    ...
    /**
     * Gives the image corresponding to the winner
     * @return  the image of the winner, or null if the game isn't over yet
     */
    ...
    public static final class Player
    {
         ...
         * @param canSee
         *          if the player can see the board
         */
        public Player(PlayerID id, int lives, SubCell position, Image image, boolean canSee)
        {
            this.id = id;
            this.lives = lives;
        ...
        /**
         * Says if the player can see the game
